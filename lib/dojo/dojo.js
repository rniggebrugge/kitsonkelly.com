...
(function (userConfig, defaultConfig) {
    ...
    var aliases = [], paths = {}, pathsMapProg = [], packs = {}, map = req.map = {}, mapProgs = [], modules = {}, cacheBust = "", cache = {}, urlKeyPrefix = "url:", pendingCacheInsert = {}, dojoSniffConfig = {};
    if (1) {
    ...
    if (has("dom") && (1 || 1)) {
        ...
        if (1) {
            var sibling = doc.getElementsByTagName("script")[0], insertPoint = sibling.parentNode;
    ...
    var def = function (mid, dependencies, factory) {
        ...
        if (targetModule && !waiting[targetModule.mid]) {
            ...
            if (!has("ie-event-behavior") || !has("host-browser") || injectingCachedModule) {
                defQ.push(args);
            } else {
...
})(this.dojoConfig || this.djConfig || this.require || {}, {async:1, hasCache:{"config-selectorEngine":"lite", "config-tlmSiblingOfDojo":1, "dojo-built":1, "dojo-loader":1, dom:1, "host-browser":1}, packages:[{location:".", name:"dojo"}, {location:"../dijit", name:"dijit"}, {location:"../dojox", name:"dojox"}, {location:"../kitsonkelly", main:"src", name:"kitsonkelly"}]});
(function () {
