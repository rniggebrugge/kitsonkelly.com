define("dijit/_editor/RichText", [
	...
	"dojo/query", // query
	"dojo/domReady",
	"dojo/sniff", // has("ie") has("mozilla")  0  has("safari") has("webkit")
...
//				}
		...
		_queryCommandAvailable: function(/*String*/ command){
			...
			return (has("ie") && supportedBy.ie) ||
				...
				( 0  && supportedBy.opera);	// Boolean return true if the command is supported, false otherwise
		},
